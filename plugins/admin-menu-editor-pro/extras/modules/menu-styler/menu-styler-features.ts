...
export namespace AmeMenuStylerJsFeatures {
	...
	class CollapseButtonTextFeature extends StylerJsFeature<CollapseButtonTextSettings> {
	...
	class MenuLogoFeature extends StylerJsFeature<MenuLogoSettings> {
		...
		private settingContainsImage(setting: ImageSettingValue): boolean {
		...
		private getImageUrl(imageSetting: ImageSettingValue): JQueryPromise<string> | string | null {
